...
public class HelloWorldService
    ...
    public client.HelloWorldInterface getHelloWorldPort() {
        return super.getPort(new QName("http://example/", "HelloWorldPort"), client.HelloWorldInterface.class);
    }
     ...
     */
    @WebEndpoint(name = "HelloWorldPort")
    public client.HelloWorldInterface getHelloWorldPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://example/", "HelloWorldPort"), client.HelloWorldInterface.class, features);
    }
